...
const string strMessageMagic = "VootCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "VootCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Darker than black";
        CTransaction txNew;
        txNew.nTime = 1401818141;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1401818141;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 4033880;
		if(fTestNet)
        {
            block.nNonce   = 4033880;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x7c5470dfc51c559e4f9fea2134e5a396a8c39eba3b40f3a6a917f2cb6bd4c7fb"));
        block.print();
